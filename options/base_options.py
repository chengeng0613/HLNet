...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # data parameters
        # parser.add_argument('--dataroot', type=str, default='E:/Ecode/N/track1')
        # E:\dataset\NTIRE
        parser.add_argument('--dataroot', type=str, default='E:\\PytorchCode\\Code2023\\NTIRE\\A_demo\\NTIRETRACK2\\Crop3')
        parser.add_argument('--dataset_name', type=str, default=['cropplus'], nargs='+')
        ...
        parser.add_argument('--name', type=str, required=False,
                help='Name of the folder to save models and logs.',default='track2')
        parser.add_argument('--model', type=str, required=False,default='hlnet')
        ...
        parser.add_argument('--crop_patch', type=int, default=64)
